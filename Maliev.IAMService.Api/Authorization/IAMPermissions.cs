...
public static class IAMPermissions
{
    ...
    /// <summary>
    /// Permission to create a new principal.
    /// </summary>
    public const string PrincipalsCreate = "iam.principals.create";
    /// <summary>
    /// Permission to read principal details.
    /// </summary>
    ...
    /// <summary>
    /// Permission to read role details.
    /// </summary>
    ...
    /// <summary>
    /// Permission to create a new role binding.
    /// </summary>
    public const string BindingsCreate = "iam.bindings.create";
    /// <summary>
    /// Permission to read role binding details.
    /// </summary>
    public const string BindingsRead = "iam.bindings.read";
    /// <summary>
    /// Permission to delete a role binding.
    /// </summary>
    ...
    /// <summary>
    /// Permission to resolve effective permissions for a principal.
    /// </summary>
    public const string AuthResolvePermissions = "iam.auth.resolve-permissions";
    /// <summary>
    /// Permission to check a specific permission for a principal.
    /// </summary>
    public const string AuthCheckPermission = "iam.auth.check-permission";
    /// <summary>
    /// Permission to issue a token for a principal.
    /// </summary>
