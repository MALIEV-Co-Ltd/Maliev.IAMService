...
public class PrincipalRoleBinding
{
    ...
    /// <summary>
    /// Gets or sets hierarchical resource path for resource-scoped role bindings.
    /// Supports wildcards: /* (single-level) and /** (multi-level). NULL for global role bindings.
    /// </summary>
    [MaxLength(500)]
