...
{
    /// <summary>
    /// Gets or sets the unique permission identifier in the format {service}.{resource}.{action}.
    /// </summary>
    [Key]
    [MaxLength(255)]
    ...
    /// <summary>
    /// Gets or sets the name of the service this permission belongs to.
    /// </summary>
    [Required]
    [MaxLength(100)]
    ...
    /// <summary>
    /// Gets or sets the type of resource this permission controls access to.
    /// </summary>
    [Required]
    [MaxLength(100)]
    ...
    /// <summary>
    /// Gets or sets the action that can be performed on the resource.
    /// </summary>
    [Required]
    [MaxLength(100)]
